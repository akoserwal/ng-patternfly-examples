...
import { WizardModule, WizardConfig, WizardComponent, WizardEvent, WizardStepConfig, WizardStepComponent, WizardStep } from 'patternfly-ng';

@Component({
  selector: 'app-wizard-embed-example',
  templateUrl: './wizard-embed-example.component.html',
  styleUrls: ['./wizard-embed-example.component.css']
})
